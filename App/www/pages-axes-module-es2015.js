...
let AxesPageModule = class AxesPageModule {
};
...
let AxesPage = class AxesPage {
    ...
    createAxis() {
        const axisScale = d3_scale__WEBPACK_IMPORTED_MODULE_5__["scaleLinear"]()
            .domain([0, 100])
            .range([0, 300]);
        this.xAxis = d3_axis__WEBPACK_IMPORTED_MODULE_6__["axisBottom"](axisScale);
    }
    createSVG() {
        const svgContainer = d3_selection__WEBPACK_IMPORTED_MODULE_4__["select"]('#axis-svg').append('svg')
            .attr('width', 300)
            .attr('height', 100);
    ...
    createOtherAxis() {
        this.elementRef.nativeElement.querySelectorAll('.svg-axis').forEach((container) => {
            ...
            const svgContainer = d3_selection__WEBPACK_IMPORTED_MODULE_4__["select"]('#' + container.id).append('svg')
...
//# sourceMappingURL=pages-axes-module-es2015.js.map