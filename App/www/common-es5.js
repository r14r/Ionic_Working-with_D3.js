...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/scales/page.html":
/*!******************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/scales/page.html ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<ion-header>\n\t<common-header *ngIf=\"!isPushed\">D3.js with Ionic</common-header>\n\t<ion-navbar *ngIf=\"isPushed\" color=\"primary\">\n\t\t<ion-title text-uppercase>Scales</ion-title>\n\t</ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n\n\t<h1 class=\"ion-no-margin\" *ngIf=\"!isPushed\">Scales</h1>\n\n\t<div class=\"ion-padding-horizontal ion-padding-bottom\">\n\t\t<p padding-top>Resize the data to fit into the pre-defined SVG Coordinate Space</p>\n\t\t<p>In this section we need to import d3-scale and d3-array:</p>\n\t</div>\n\n\n\n\t<h2 class=\"ion-margin-bottom\">Linear Scale Example</h2>\n\t<div class=\"ion-padding-horizontal\">\n\t</div>\n\n\n\t<div class=\"ion-padding\">\n\n\t\t<h3 class=\"ion-no-padding\">Initial Data</h3>\n\t\t<p *ngIf=\"initialDataToScale\">{{initialDataToScale.join(' | ')}}</p>\n\n\t\t<h3 class=\"ion-no-padding\">Scaled Data</h3>\n\t\t<p *ngIf=\"scaledData\">{{scaledData.join(' | ')}}</p>\n\n\t</div>\n\n\n\t<h2 class=\"ion-margin-bottom\">Other interpolators available</h2>\n\t<div class=\"ion-padding-horizontal ion-padding-bottom\">\n\t\t<ul>\n\t\t\t<li>scaleBand</li>\n\t\t\t<li>scaleIdentity</li>\n\t\t\t<li>scaleLinear</li>\n\t\t\t<li>scaleLog</li>\n\t\t\t<li>scaleOrdinal</li>\n\t\t\t<li>scalePoint</li>\n\t\t\t<li>scalePow</li>\n\t\t\t<li>scaleQuantile</li>\n\t\t\t<li>scaleQuantize</li>\n\t\t\t<li>scaleSequential</li>\n\t\t\t<li>scaleSqrt</li>\n\t\t\t<li>scaleThreshold</li>\n\t\t\t<li>scaleTime</li>\n\t\t\t<li>scaleUtc</li>\n\t\t</ul>\n\t</div>\n\n\n\t<footer-links *ngIf=\"!isPushed\" color=\"dark\" class=\"ion-no-margin\"\n\t\ttutorialUrl=\"https://www.dashingd3js.com/d3js-scales\">\n\t</footer-links>\n\n</ion-content>"

/***/ }),

/***/ "./src/app/pages/chart-bar/basic/data/data.ts":
/*!****************************************************!*\
  !*** ./src/app/pages/chart-bar/basic/data/data.ts ***!
  \****************************************************/
/*! exports provided: StatsPieChart, StatsBarChart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatsPieChart", function() { return StatsPieChart; });
...
/***/ "./src/app/pages/scales/page.scss":
/*!****************************************!*\
  !*** ./src/app/pages/scales/page.scss ***!
  \****************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3NjYWxlcy9wYWdlLnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/pages/scales/page.ts":
/*!**************************************!*\
  !*** ./src/app/pages/scales/page.ts ***!
  \**************************************/
/*! exports provided: ScalesPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScalesPage", function() { return ScalesPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var ScalesPage = /** @class */ (function () {
    function ScalesPage(router, activatedRoute) {
        this.router = router;
        ...
        this.scaledData = [];
        this.isPushed = false;
        this.isPushed = this.activatedRoute.snapshot.params["isPushed"] || false;
    }
    ScalesPage.prototype.ngOnInit = function () {
        this.createScales();
    };
    ScalesPage.prototype.createScales = function () {
        this.initialDataToScale = [0, 1000, 3000, 2000, 5000, 4000, 7000, 6000, 9000, 8000, 10000];
        var linearScale = d3_scale__WEBPACK_IMPORTED_MODULE_3__["scaleLinear"]()
            // Sets the scale’s domain to the specified array of numbers.
            .domain([
            d3_array__WEBPACK_IMPORTED_MODULE_4__["min"](this.initialDataToScale),
            d3_array__WEBPACK_IMPORTED_MODULE_4__["max"](this.initialDataToScale)
        ])
            // Sets the scale’s range to the specified array of values
            .range([0, 100]);
        this.scaledData = this.initialDataToScale.map(function (data) { return linearScale(data); });
    };
    ScalesPage.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
    ScalesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'page-scales',
            template: __webpack_require__(/*! raw-loader!./page.html */ "./node_modules/raw-loader/index.js!./src/app/pages/scales/page.html"),
            styles: [__webpack_require__(/*! ./page.scss */ "./src/app/pages/scales/page.scss")]
        }),
