...
var TooltipsBarChartPageModule = /** @class */ (function () {
    function TooltipsBarChartPageModule() {
    }
    ...
    return TooltipsBarChartPageModule;
}());
...
var TooltipsBarChartPage = /** @class */ (function () {
    function TooltipsBarChartPage() {
    ...
    TooltipsBarChartPage.prototype.ngOnDestroy = function () { this.toolbox.log('ngOnDestroy'); };
    TooltipsBarChartPage.prototype.ngOnInit = function () {
        this.toolbox.log('ngOnInit');
        this.demo();
    };
    TooltipsBarChartPage.prototype.demo = function () {
        this.toolbox.log('demo');
        var margin = { top: 40, right: 20, bottom: 30, left: 40 };
        var width = 960 - margin.left - margin.right;
        var height = 500 - margin.top - margin.bottom;
        var x = d3_scale__WEBPACK_IMPORTED_MODULE_3__["scaleOrdinal"]().domain([0, 100]).range([0, width]);
        var y = d3_scale__WEBPACK_IMPORTED_MODULE_3__["scaleLinear"]().domain([0, 100]).range([height, 0]);
        var xAxis = d3_axis__WEBPACK_IMPORTED_MODULE_4__["axisBottom"](x);
        var yAxis = d3_axis__WEBPACK_IMPORTED_MODULE_4__["axisLeft"](y).tickFormat(d3__WEBPACK_IMPORTED_MODULE_2__["format"]('.0%'));
        ...
        svg.call(tip);
        */
        d3__WEBPACK_IMPORTED_MODULE_2__["tsv"]('/assets/data/tooltips_barchart.tsv', type, function (error, data) {
            x.domain(data.map(function (d) { return d.letter; }));
            y.domain([0, d3__WEBPACK_IMPORTED_MODULE_2__["max"](data, function (d) { return d.frequency; })]);
            svg.append('g')
                .attr('class', 'x axis')
...
//# sourceMappingURL=pages-interactivity-tooltips_barchart-module-es5.js.map