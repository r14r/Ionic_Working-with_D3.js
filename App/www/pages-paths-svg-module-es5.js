...
var PathsSvgPageModule = /** @class */ (function () {
    function PathsSvgPageModule() {
    }
...
var PathsSvgPage = /** @class */ (function () {
    function PathsSvgPage() {
        ...
        this.interpolationsSelectList = this.interpolations.map(function (interpolation) { return interpolation.name; });
    }
    PathsSvgPage.prototype.ngAfterViewInit = function () {
        this.createSvgPathsLines();
    };
    PathsSvgPage.prototype.createSvgPathsLines = function () {
        var _this = this;
        // Data set
        var lineData = [
            { x: 1, y: 90 }, { x: 20, y: 20 },
        ...
        var svgContainer = d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"]('#paths').append('svg')
            .attr('width', 300)
            .attr('height', 200)
            .style('border', '1px solid black');
        // Generator
        var lineGenerator = d3_shape__WEBPACK_IMPORTED_MODULE_3__["line"]()
            .x(function (d) { return d.x; })
            .y(function (d) { return d.y; })
            .curve(this.interpolations.find(function (intplt) { return intplt.name === _this.interpolationSelected; }).value);
...
//# sourceMappingURL=pages-paths-svg-module-es5.js.map