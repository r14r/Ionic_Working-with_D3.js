...
var BasicElementsPageModule = /** @class */ (function () {
    function BasicElementsPageModule() {
    }
    ...
    return BasicElementsPageModule;
}());
...
var BasicElementsPage = /** @class */ (function () {
    function BasicElementsPage() {
    ...
    BasicElementsPage.prototype.ngOnInit = function () {
        this.createCircles();
        this.createCoordinateCircles();
    };
    BasicElementsPage.prototype.createCircles = function () {
        var circleRadii = [40, 20, 10];
        var svgContainer = d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"]('#circles-basic').append('svg')
            .attr('width', 300)
            .attr('height', 100)
    ...
    BasicElementsPage.prototype.createCoordinateCircles = function () {
        var spaceCircles = [30, 70, 110];
        var svgContainer = d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"]('#coordinateCircles').append('svg')
            .attr('width', 300)
            .attr('height', 200)
            .style('border', '1px solid black');
...
//# sourceMappingURL=pages-basic-elements-module-es5.js.map