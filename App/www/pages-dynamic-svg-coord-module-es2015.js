...
let DynamicSvgCoordPageModule = class DynamicSvgCoordPageModule {
};
...
let DynamicSvgCoordPage = class DynamicSvgCoordPage {
    constructor() {
    ...
    createDynamicSvg() {
        ...
        const max = this.getMaxSVG(jsonRectangles, 'x', 'y', 'width', 'height');
        const svgContainer = d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"]('#dynamicSvg').append('svg')
     ...
     */
    getMaxSVG(data, xKey, yKey, wKey, hKey) {
        const max = {
            x: 0,
            y: 0
        };
...
//# sourceMappingURL=pages-dynamic-svg-coord-module-es2015.js.map