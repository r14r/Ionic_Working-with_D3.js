...
var RotatedTextPageModule = /** @class */ (function () {
    function RotatedTextPageModule() {
    }
...
var RotatedTextPage = /** @class */ (function () {
    function RotatedTextPage() {
    ...
    RotatedTextPage.prototype.ngOnInit = function () {
        this.toolbox.log('ngOnInit');
        this.demo();
    };
    RotatedTextPage.prototype.demo = function () {
        ...
        d3__WEBPACK_IMPORTED_MODULE_2__["csv"]('/assets/data/date_value.csv', function (item) {
            ...
            var x = d3__WEBPACK_IMPORTED_MODULE_2__["scaleTime"]()
                .domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](data, function (d) { return d.date; }))
                .range([0, width]);
            svg.append('g')
            ...
            var y = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]()
                .domain([0, d3__WEBPACK_IMPORTED_MODULE_2__["max"](data, function (d) { return +d.value; })])
                .range([height, 0]);
            svg.append('g')
...
//# sourceMappingURL=pages-text-rotated-text-module-es5.js.map